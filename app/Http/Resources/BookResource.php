...
class BookResource extends JsonResource
{
    ...
    public function toArray($request)
    {
         return [
            ...
            'PDF' => asset(config('upload_path.books') . $this->ebook),
            'sample_audio' => $this->sample_audio ? asset(config('upload_path.books') . $this->sample_audio) : null,
            'prices' => [
            ...
            'images' => [
                'front' => asset(config('upload_path.books') . $this->front_image),
                'back' => asset(config('upload_path.books') . $this->back_image),
