                ...
                <div id="kt_app_toolbar" class="app-toolbar mt-5 py-3 py-lg-6">
                    ...
                    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center gap-2 gap-lg-3">
                            ...
                            <a href="{{ route('announcements.create') }}" class="btn btn-sm fw-bold btn-primary">Add New Announcement</a>
                            <a href="{{ route('admin.announcements.trash.records') }}" title="Contacted Us All Trash Records" class="btn btn-sm fw-bold btn-primary">Restore</a>
