                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                @if(!empty($category))
                                <form action="{{$store_route}}" method="POST" enctype="multipart/form-data" class="form form-horizontal">
                                    @else
                                    <form action="{{$store_route}}" method="POST" enctype="multipart/form-data" class="form form-horizontal">
                                        @endif
                                        @csrf
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="position-relative has-icon-left">
                                                                <select name="category_id" class="form-control" required>
                                                                    ...
                                                                    <option value="{{$value->id}}" @if($value->id == $category->id) selected @endif>{{ucfirst($value->title)}}</option>
                                                                    @endforeach
                                                                    @endif
                                                                </select>
