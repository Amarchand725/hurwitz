        ...
        <div class="card-body">
          <div class="row">
            <div class="col-md-9 text-left">
              <h2> @if(!empty($title)) {{$title}} <span class="text-danger"> @if(isset($count) && !empty($count)) ({{$count}}) @endif </span> @endif </h2>
            </div>
            <div class="col-md-3 text-right">

              <a href="{{route('admin.categories.index')}}" class="btn btn-success">Categories</a>
              <a href="{{  $create_route }}" class="btn btn-primary">New</a>
            </div>
          </div>
          <div class="row mt-2">
            <div class="col-md-12">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <img src="{{asset(config('upload_path.sub_category') . $value->image )}}" alt="{{$value->title}}" width="100" height="100">
                      @else
                    ...
                    <td>
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-end" style="">
                            <a class="dropdown-item" href="{{route('admin.sub-categories.edit' , $value->id)}}">
                            ...
                            <form id="destroyForm_{{$value->id}}" action="{{route('admin.sub-categories.destroy' , $value->id)}}" method="POST" class="d-none">
                                @csrf
                                @method('delete')
                            </form>
                          </div>
