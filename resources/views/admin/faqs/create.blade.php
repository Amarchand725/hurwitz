    ...
    <div id="kt_app_content_container" class="app-container ">
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="" class="collapse show">
                <form action="{{ route('faqs.store') }}" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    @csrf
                    ...
                    <div class="card-body border-top p-9">
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <textarea name="question" class="form-control" id="" cols="30" rows="5" placeholder="Enter Question here.">{{ old('question') }}</textarea>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <textarea name="answer" class="form-control" id="" cols="30" rows="5" placeholder="Enter answer here.">{{ old('answer') }}</textarea>
                    ...
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        <a href="{{ route('faqs.index') }}" type="reset" class="btn btn-white btn-active-light-primary me-2">Discard</a>
