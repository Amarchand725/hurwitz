...
@section('content')
<input type="hidden" id="page_url" value="{{ route('orders.index') }}">
                ...
                <div id="kt_app_toolbar" class="app-toolbar mt-5 py-3 py-lg-6">
                    ...
                    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center gap-2 gap-lg-3">
                            ...
                            <a href="{{ route('admin.orders.trash.records') }}" title="Orders All Trash Records" class="btn btn-sm fw-bold btn-primary">Restore</a>
                                    ...
                                    <tbody id="body">
                                        @foreach ($models as $key=>$model)
                                            <tr id="id-{{ $model->id }}">
                                                ...
                                                <td>
                                                    <a href="{{route('orders.show', $model->id)}}" data-toggle="tooltip" data-placement="top" title="Show Details" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a>
                                                    <button class="btn btn-danger btn-sm delete" data-slug="{{ $model->id }}" data-del-url="{{ route('orders.destroy', $model->id) }}"><i class="fa fa-trash"></i></button>
                                                </td>
                                            </tr>
                                        @endforeach
                                        <tr>
