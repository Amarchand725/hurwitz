            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form action="{{route('admin.categories.update', $edit->id)}}" method="POST" enctype="multipart/form-data" class="form form-horizontal" >
                                @csrf
                                @method("PUT")
                                <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="position-relative has-icon-left">
                                                            @if(!empty($edit->image))
                                                            <img id="prev_main_image" src="{{asset(config('upload_path.category') . $edit->image )}}" style="max-width:500px;">
                                                            @else
