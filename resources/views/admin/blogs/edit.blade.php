    ...
    <div id="kt_app_content_container" class="app-container ">
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="" class="collapse show">
                <!--begin::Form-->
                <form action="{{ route('blogs.update', $edit->id) }}" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    @csrf
                    @method('PUT')
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <textarea name="short_description" id="" cols="30" rows="5" class="form-control">{{ $edit->short_description }}</textarea>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <textarea name="long_description" id="" cols="30" rows="5" class="form-control long_description">{{ $edit->long_description }}</textarea>
                        ...
                        @if($edit->image)
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <img src="{{ asset('public/images/blogs') }}/{{ $edit->image }}" alt="">
                                </div>
                            </div>
                        @endif
                        <div class="row mb-6">
                        ...
                        @if($edit->featured_image)
                            <div class="row mb-6">
                                <label class="col-lg-2 col-form-label required fw-bold fs-6">Featured Image Exist</label>

                                <div class="col-lg-8 fv-row">
                                    <img src="{{ asset('public/images/blogs') }}/{{ $edit->featured_image }}" alt="" width="60" height="70">
                                </div>
                            </div>
                        @endif
                        <div class="row mb-6">
