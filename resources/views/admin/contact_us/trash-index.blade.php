...
@section('content')
<input type="hidden" id="page_url" value="{{ route('admin.contacts.trash.records') }}">
                ...
                <div id="kt_app_toolbar" class="app-toolbar mt-5 py-3 py-lg-6">
                    ...
                    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center gap-2 gap-lg-3">
                            ...
                            <a href="{{ route('contacts.index') }}" title="All Contacted Us" class="btn btn-primary btn-sm">View All</a>
                            <!--end::Primary button-->
                        </div>
                        <!--end::Actions-->
                    </div>
