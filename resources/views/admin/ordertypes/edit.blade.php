        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div class="card-header border-0 cursor-pointer" role="button" >
                ...
                <div class="content-header-right mt-3">
                    <a href="{{ route('ordertypes.index') }}" title="All Books" class="btn btn-primary btn-sm">View All</a>
                </div>
                <!--end::Card title-->
            </div>
            <!--begin::Card header-->
            ...
            <div id="" class="collapse show">
                <!--begin::Form-->
                <form action="{{ route('ordertypes.update', $edit->id) }}" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        <a href="{{ route('ordertypes.index') }}" type="reset" class="btn btn-white btn-active-light-primary me-2">Discard</a>
