                ...
                <div id="kt_app_toolbar" class="app-toolbar mt-5 py-3 py-lg-6">
                    ...
                    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center gap-2 gap-lg-3">
                            ...
                            <a href="{{ route('testimonials.index') }}" title="All Testimonials" class="btn btn-sm fw-bold btn-primary">View All</a>
                        </div>
                        <!--end::Actions-->
                    </div>
                            ...
                            <div class="card-body pt-6">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (!empty($show->image))
                                                <img class="m-5" src="{{ asset('public/images/testimonials/' . $show->image) }}"
