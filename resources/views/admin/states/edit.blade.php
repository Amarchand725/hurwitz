    ...
    <div id="kt_app_content_container" class="app-container ">
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="" class="collapse show">
                <!--begin::Form-->
                <form action="{{ route('states.update', $edit->id) }}" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="col-lg-8 fv-row">
                                <select name="country_id" class="form-control" data-live-search="true">
                                    ...
                                    @foreach($countries as $index=>$value)
                                        <option value="{{$value->id}}" {{ $edit->country_id==$value->id?'selected':'' }} >{{$value->name}}</option>
                                    @endforeach
                                </select>
