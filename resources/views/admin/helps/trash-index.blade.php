...
@section('content')
<input type="hidden" id="page_url" value="{{ route('admin.ordertypes.trash.records') }}">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <li class="breadcrumb-item text-muted" style=" width: 100%; ">
                                            <input type="hidden" id="search" class="form-control" placeholder="Search...">
                                    ...
                                    <tbody id="body">
                                        @foreach ($models as $key=>$model)
                                            <tr id="id-{{ $model->id }}">
                                                ...
                                                <td>
                                                    <a href="{{route('admin.announcements.restore', $model->id)}}" data-toggle="tooltip" data-placement="top" title="Restore Record" class="btn btn-primary btn-sm"><i class="fa fa-refresh"></i> Restore</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        <tr>
